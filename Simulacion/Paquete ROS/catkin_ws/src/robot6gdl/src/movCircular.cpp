...
int main(int arc,char **arcv)
{
    ...
    //Variable para definir si el robot se queda fijo o se mueve
    int fixed;
    ...
    std::cout<<"EMPIEZA LA GENERACIÓN DE TRAYECTORIA CIRCULAR\n";
    
    std::tuple<Array3Xd,ArrayXXd> cinematic{generarTrayectoriaCircular(n,arregloTiempo)};
