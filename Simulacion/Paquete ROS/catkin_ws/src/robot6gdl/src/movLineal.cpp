...
int main(int arc,char **arcv)
{
   ...
   std::tuple<Array3Xd,ArrayXXd> cinematic{generarTrayectoriaLineaRecta(n,arregloTiempo)};

   Eigen::Array3Xd X_0H{std::get<0>(cinematic)};
   Eigen::ArrayXXd Qs{std::get<1>(cinematic)};
